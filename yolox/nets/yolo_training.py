...
from nets.loss import MyIoULoss


class YOLOLoss(nn.Module):
    def __init__(self, num_classes, fp16, iou_type, strides=[8, 16, 32]):
        super().__init__()
        ...
        self.iou_loss = MyIoULoss(box_type='centerwh', iou_type=self.iou_type)
